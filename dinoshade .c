...
static float lightAngle = -0.5, lightHeight = 20;
GLfloat angle = -150;   /* in degrees */
GLfloat angle2 = 30;   /* in degrees */
GLfloat angle3 = 45.0f;
int refreshmill = 1;
...
static GLfloat skinColor[]={0.7,0.7,0.7,0.0}, eyeColor[] = {0.0,0.0,0.0,0.0};
...
main(int argc, char **argv)
{
  ...
  glutCreateWindow("Shadowy Leapin' Dinosaur");
  ...
  glutAddMenuEntry("Toggle jump and light source motion", M_MOTION);
